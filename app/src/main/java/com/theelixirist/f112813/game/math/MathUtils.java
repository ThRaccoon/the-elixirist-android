...
public class MathUtils {
    private static final int MAX_PRECOMPUTED_POWER = 92;
    private static final double[] PRECOMPUTED_POWERS_OF_TEN = new double[MAX_PRECOMPUTED_POWER + 1];

    static {
        for (int i = 0; i <= MAX_PRECOMPUTED_POWER; i++) {
